...
namespace nm916616MIS4200.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "orderNumb,description,orderDate,customerID")] Orders orders)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "orderNumb,description,orderDate,customerID")] Orders orders)
        {
            if (ModelState.IsValid)
            {
